...
def load_wdbc_data(filename):
    ...
    with open(filename) as f:
        for line in f.readlines():
            ...
            wdbc.data.append([float(item) for item in items[2:]])
...
if __name__ == '__main__':
    ...
    # wdbc = load_wdbc_data('ml01_lab/data/wdbc.data')
    ...
    conf_disp = metrics.ConfusionMatrixDisplay(
        cm, display_labels=['false', 'true'])
    conf_disp.plot()
